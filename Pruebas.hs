...
-- AFND N6a para el lenguaje de las palabras que solo contienen una 'a' o que terminan en 'a'
getAutomataN6a :: Af
getAutomataN6a = ([0,1,2,3],['a','b','c'],[(0,'a',1),(0,'b',2),(0,'c',2),(1,'a',3),(1,'b',1),(1,'c',1),(2,'a',4),(2,'b',2),(2,'c',2),(3,'a',3),(3,'b',5),(3,'c',5),(4,'a',3),(4,'b',1),(4,'c',1),(5,'a',3),(5,'b',5),(5,'c',5)],0,[1,3])
...
-- AFND N7a para el lenguaje ({a}({b}({a}U{b})*{a})*)+{c}*
getAutomataN7a :: Af
getAutomataN7a = ([0,1,2,3],['a','b','c'],[(0,'a',2),(0,'b',1),(0,'c',1),(1,'a',1),(1,'b',1),(1,'c',1),(2,'a',2),(2,'b',3),(2,'c',4),(3,'a',5),(3,'b',3),(3,'c',1),(4,'a',1),(4,'b',1),(4,'c',4),(5,'a',5),(5,'b',3),(5,'c',4)],0,[1,3])
